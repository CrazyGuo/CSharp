...
namespace IBatisQueryGenerator
{
    ...
    {
        public string begin(string db,string table)
        {
            config.DbDatabase = db;
            config.TableName = table;
            StringBuilder builder=new StringBuilder ();
            builder.Append("public class " + config.TableName + "\r\n");
            builder.Append("{\r\n");
    ...
    public class DbHelper
    {
        ...
        public static List<DbTable> GetDbTables(string connectionString, string database, string tables = null)
        {
            ...
            return dt.Rows.Cast<DataRow>().Select(row => new DbTable
            {
                ...
                SchemaName = row["schemname"].ToString(),//row.Field<string>("schemname"),
                Rows = (int)row["rows"],//,row.Field<int>("rows"),
                HasPrimaryKey = (bool)row["HasPrimaryKey"],//row.Field<bool>("HasPrimaryKey"),
        ...
        public static List<DbColumn> GetDbColumns(string connectionString, string database, string tableName, string schema = "dbo")
        {
            ...
            return dt.Rows.Cast<DataRow>().Select(row => new DbColumn()
            {
                ...
                IsPrimaryKey = (bool)row["IsPrimaryKey"],// row.Field<bool>("IsPrimaryKey"),
                ColumnName = row["ColumnName"].ToString(),//row.Field<string>("ColumnName"),
                ColumnType = row["ColumnType"].ToString(),//row.Field<string>("ColumnType"),
                IsIdentity = (bool)row["IsIdentity"],//row.Field<bool>("IsIdentity"),
                IsNullable = (bool)row["IsNullable"],//row.Field<bool>("IsNullable"),
                ByteLength = (int)row["ByteLength"],//row.Field<int>("ByteLength"),
                CharLength = (int)row["CharLength"],//row.Field<int>("CharLength"),
                Scale = (int)row["Scale"],//row.Field<int>("Scale"),
    ...
    public class config
    {
        public static readonly string ConnectionString = "Data Source=(local);Initial Catalog=PTS;User ID=sa;Password=Abcd1234;";
        public static  string DbDatabase = "PTS";
        public static  string TableName = "CfbSpindles";
        public static  string nameSpace = "App.Sys";
    }
}
