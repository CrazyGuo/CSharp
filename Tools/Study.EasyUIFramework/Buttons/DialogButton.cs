...
namespace Study.EasyUIFramework.Buttons 
{
    ...
    /// 弹出窗口按钮
    /// </summary>
    public class DialogButton : LinkButton<IDialogButton>, IDialogButton 
    {
        /// <summary>
        /// 初始化弹出窗口按钮
        /// </summary>
        ...
        public IDialogButton Title( string title ) {
            Builder.Add( "title", GetValue( title ) );
            return This();
        }
        ...
        public IDialogButton Buttons( string buttonDivId ) {
            Builder.Add( "buttons", GetValue( buttonDivId ) );
            return This();
        }
        ...
        {
            Builder.Add( "icon", GetValue( iconClass ) );
            return This();
        }
        ...
        {
            Builder.Add( "maximizable", GetValue( allow ) );
            return This();
        }
