...
namespace MyBatis.Common.Utilities
{
    ...
    public static class TypeUtils
    {
        ...
        /// <summary>
        /// Determines whether the specified type is implement generic Ilist interface. 判断Type是否为泛型
        /// </summary>
        /// <param name="type">The type.</param>
        /// <returns>
        ...
        public static bool IsImplementGenericIListInterface(Type type)
        {
            ...
            if (!type.IsGenericType)//获取一个值，该值指示当前类型是否为泛型类型
            {
                ret = false;
            }
            ...
            Type[] interfaceTypes = type.GetInterfaces();//获取由当前 Type 实现或继承的特定接口
