...
namespace MyBatis.Common.Resources
{
    ...
    public class CustomUriBuilder
    {
        ...
        public CustomUriBuilder(string resourceUri, string basePath)
        {
            ...
            {
                int index = FileResourceLoader.Scheme.Length + Uri.SchemeDelimiter.Length;//“file://”的长度
                resourceUri = resourceUri.Substring(index);//"file://"字符串以后的字符内容
