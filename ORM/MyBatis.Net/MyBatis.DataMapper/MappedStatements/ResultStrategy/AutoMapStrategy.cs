...
namespace MyBatis.DataMapper.MappedStatements.ResultStrategy
{
    ...
    public sealed class AutoMapStrategy : IResultStrategy
    {
        ...
        public object Process(RequestScope request, ref IDataReader reader, object resultObject)
        {
            ...
            //根据reader的字段从resultObject类中获取对应的属性类集合到AutoResultMap中 不包括具体的值
            ...
            //将reader的具体值赋值到outObject类中对应的属性property中
            for (int index = 0; index < resultMap.Properties.Count; index++)
            {
                ResultProperty property = resultMap.Properties[index];
                resultMap.SetValueOfProperty(ref outObject, property,property.GetDataBaseValue(reader));
            }
