...
namespace MyBatis.DataMapper.Model.Statements
{
	...
	public class PreparedStatementFactory
	{
            ...
            string commandText)
		{
            ...
            this.session = session;//DataMapperSession类对象
            this.request = request;//总管类 包含数据库相关类 和 ISatement对象
            this.statement = statement;//和request中的IStatement类一样 包含sql语句和参数类
            this.commandText = commandText;//和IStatement中的SQL语句一样
