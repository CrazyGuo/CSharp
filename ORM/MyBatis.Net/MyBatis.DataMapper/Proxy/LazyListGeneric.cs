...
namespace MyBatis.DataMapper.Proxy
{
...

    {
        ...
        private void Load(string methodName)
        {
            ...
            lock (syncLock)
            {
                if (_loaded == false)
                {
                    ...
                    _list = dataMapper.QueryForList<T>(_statementId, _param);
                    _loaded = true;
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="IEnumerator"></see> that can be used to iterate through the collection.
        /// </returns>
        ...
        /// </summary>
        /// <value></value>
        /// <returns>The number of elements contained in the <see cref="ICollection"></see>.</returns>
