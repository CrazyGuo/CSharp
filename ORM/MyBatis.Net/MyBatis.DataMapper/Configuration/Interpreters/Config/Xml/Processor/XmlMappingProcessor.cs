...
namespace MyBatis.DataMapper.Configuration.Interpreters.Config.Xml.Processor
{
    ...
    public partial class XmlMappingProcessor : BaseXmlProcessor
    {
		...
		{
            RegisterElementHandler(ConfigConstants.ELEMENT_SQLMAP, ProcessSqlMapElement);//ok
            ...
            RegisterElementHandler(ConfigConstants.ELEMENT_SELECT, ProcessStatementElement);//ok
            RegisterElementHandler(ConfigConstants.ELEMENT_STATEMENT, ProcessStatementElement);//ok
            RegisterElementHandler(ConfigConstants.ELEMENT_UPDATE, ProcessStatementElement);//ok
            RegisterElementHandler(ConfigConstants.ELEMENT_DELETE, ProcessStatementElement);//ok
            RegisterElementHandler(ConfigConstants.ELEMENT_INSERT, ProcessStatementElement);//ok
            RegisterElementHandler(ConfigConstants.ELEMENT_PROCEDURE, ProcessStatementElement);//ok
