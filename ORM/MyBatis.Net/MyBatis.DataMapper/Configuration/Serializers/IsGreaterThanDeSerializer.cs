...
namespace MyBatis.DataMapper.Configuration.Serializers
{
	...
	/// </summary>
    public sealed class IsGreaterThanDeSerializer : BaseDynamicDeSerializer
	{
        /// <summary>
        /// Initializes a new instance of the <see cref="IsGreaterThanDeSerializer"/> class.
        /// </summary>
        /// <param name="accessorFactory">The accessor factory.</param>
        public IsGreaterThanDeSerializer(AccessorFactory accessorFactory)
