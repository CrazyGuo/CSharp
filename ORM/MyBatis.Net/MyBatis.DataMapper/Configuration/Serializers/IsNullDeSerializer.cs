...
namespace MyBatis.DataMapper.Configuration.Serializers
{
	...
	/// </summary>
    public sealed class IsNullDeSerializer : BaseDynamicDeSerializer
	{
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNullDeSerializer"/> class.
        /// </summary>
        /// <param name="accessorFactory">The accessor factory.</param>
        public IsNullDeSerializer(AccessorFactory accessorFactory)
