...
namespace MyBatis.DataMapper.Configuration.Serializers
{
	...
	/// </summary>
    public sealed class DynamicDeSerializer : BaseDynamicDeSerializer
	{
        /// <summary>
		...
		{
            Dynamic dynamic = new Dynamic(accessorFactory);

            dynamic.Prepend = ConfigurationUtils.GetStringAttribute(configuration.Attributes, "prepend");
