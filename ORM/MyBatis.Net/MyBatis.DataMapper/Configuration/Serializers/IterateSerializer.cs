...
namespace MyBatis.DataMapper.Configuration.Serializers
{
	...
	/// </summary>
	public sealed class IterateSerializer : BaseDynamicDeSerializer
	{
        /// <summary>
        /// Initializes a new instance of the <see cref="IterateSerializer"/> class.
        /// </summary>
        /// <param name="accessorFactory">The accessor factory.</param>
        public IterateSerializer(AccessorFactory accessorFactory)
