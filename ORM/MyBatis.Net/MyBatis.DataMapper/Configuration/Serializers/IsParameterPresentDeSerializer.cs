...
namespace MyBatis.DataMapper.Configuration.Serializers
{
	...
	/// </summary>
    public sealed class IsParameterPresentDeSerializer : BaseDynamicDeSerializer
	{
        /// <summary>
        ...
        /// <summary>
        /// Deserializes the specified configuration in an <see cref="IsParameterPresent"/> object
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <returns></returns>
        public override SqlTag Deserialize(IConfiguration configuration)
		{
            IsParameterPresent isParameterPresent = new IsParameterPresent(accessorFactory);

			isParameterPresent.Prepend = ConfigurationUtils.GetStringAttribute(configuration.Attributes, "prepend");
