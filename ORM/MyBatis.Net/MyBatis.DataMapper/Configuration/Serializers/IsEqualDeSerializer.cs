...
namespace MyBatis.DataMapper.Configuration.Serializers
{
	...
	/// </summary>
    public sealed class IsEqualDeSerializer : BaseDynamicDeSerializer
	{
        /// <summary>
        /// Initializes a new instance of the <see cref="IsEqualDeSerializer"/> class.
        /// </summary>
        /// <param name="accessorFactory">The accessor factory.</param>
        public IsEqualDeSerializer(AccessorFactory accessorFactory)
